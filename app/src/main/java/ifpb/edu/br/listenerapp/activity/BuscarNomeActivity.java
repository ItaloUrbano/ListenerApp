package ifpb.edu.br.listenerapp.activity;
...
import ifpb.edu.br.listenerapp.R;
import ifpb.edu.br.listenerapp.asynctask.BuscarNomeAsyncTask;
import ifpb.edu.br.listenerapp.listener.BuscarNomeTextWatcher;
...
public class BuscarNomeActivity extends Activity implements TextWatcher{
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        nomeEditText.addTextChangedListener(new BuscarNomeTextWatcher());
